<template>
    <div  class="vdr" :class="{ draggable: draggable, resizable: resizable, active: active }"
         @mousedown="elmDown" @dblclick="maximize" :style="style"
         :parent="false" @activated="onActivate" @deactivated="onDeactivate" @resizing="onResize" @dragging="onDrag"
         :x="0" :y="0"  :grid="[25,25]">
        <div
                class="handle"
                v-if="resizable"
...
<style scoped>
    ...
    .handle {
        ...
        font-size: 1px;
        background: #EEE;
        border: 1px solid rgba(0, 27, 240, 0.47);
    }
/*    .handle-tl {
        top: -10px;
        left: -10px;
